          ...
          <div className="footer_company">
            ...
            <div>
              <p>
                ...
                with real property collateral. <br>/br><br></br>Headquartered in Dubai, United Arab Emirates, and dedicated to break down the barriers of real estate investment through tokenization of property, and allowing individual investors to own property everywhere, anytime  
              </p>
            ...
            <ul>
              ...
              <li>
                <a
                  ...
                  className="footer_li"
                >
                  Be part of the Libertum Project
                </a>
              </li>
            </ul>
