      ...
      <section className="services_section">
        <div className="services_text">
          ...
          <p>
            ...
            the first place we have the DeFi 1.0 loans with the plus of minting
            stablecoins, in the second we will have the real estate marketplace
            and finally encourage other projects to incur in offering loan
            services with real collaterals
          </p>
        </div>
